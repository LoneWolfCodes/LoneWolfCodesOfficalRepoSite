          ...
          <div className="col-lg-8 col-md-10">
            <div className="s-head text-center mb-80">
              <h6 className="stit mb-30">
                <span className="left"></span>Lone Wolf Pricing Package
                <span className="right"></span>
              </h6>
              <h2>Low cost package for Web Development!</h2>
            </div>
          </div>
        </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-4">
              <div className="item active sm-padding md-mb50">
                ...
                <div className="order mb-40">
                  <a href="https://forms.gle/JNpvsvCG1yaVxuLAA" className="butn-gr rounded buton">
                    <span>SELECT</span>
                  </a>
                </div>
                <div className="feat">
